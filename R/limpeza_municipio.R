...
mdip_ssp %>%  mutate (municipio_limpo = case_when(
  ...
  municipio_circunscricao == "Capela Do Alto" ~ "Capela do Alto",
  ...
  municipio_circunscricao == "Embu-Guacu" ~ "Embu-Guaçu",
  municipio_circunscricao == "Embu Das Artes" ~ "Embu das Artes",
  municipio_circunscricao %in% c("Espirito Sto. Pinhal", "Espírito Santo Do Pinhal") ~ "Espírito Santo do Pinhal",
  municipio_circunscricao == "Fernandopolis" ~ "Fernandópolis",
  municipio_circunscricao == "Ferraz De Vasconcelos" ~ "Ferraz de Vasconcelos",
  municipio_circunscricao == "Florida Paulista" ~ "Flórida Paulista",
  municipio_circunscricao == "Franco Da Rocha" ~ "Franco da Rocha",
  municipio_circunscricao == "Gaviao Peixoto" ~ "Gavião Peixoto",
  municipio_circunscricao == "Guaira" ~ "Guaíra",
  municipio_circunscricao == "Guapiacu" ~ "Guapiaçu",
  municipio_circunscricao == "Guaracai" ~ "Guaraçaí",
  municipio_circunscricao == "Guaratingueta" ~ "Guaratinguetá",
  municipio_circunscricao == "Guarei" ~ "Guareí",
  municipio_circunscricao == "Guaruja" ~ "Guarujá",
  municipio_circunscricao == "Hortolandia" ~ "Hortolândia",
  municipio_circunscricao == "Ibira" ~ "Ibirá",
  municipio_circunscricao == "Ibiuna" ~ "Ibiúna",
  municipio_circunscricao == "Igarata" ~ "Igaratá",
  municipio_circunscricao == "Inubia Paulista" ~ "Inúbia Paulista",
  municipio_circunscricao == "Ipero" ~ "Iperó",
  municipio_circunscricao == "Ipeuna" ~ "Ipeúna",
  municipio_circunscricao == "Ipigua" ~ "Ipiguá",
  municipio_circunscricao == "Iracemapolis" ~ "Iracemápolis",
  municipio_circunscricao == "Itai" ~ "Itaí",
  municipio_circunscricao == "Itanhaem" ~ "Itanhaém"
  municipio_circunscricao == "Itapecerica Da Serra" ~ "Itapecerica da Serra",
  municipio_circunscricao == "Itapirapua Paulista" ~ "Itapirapuã Paulista",
  municipio_circunscricao == "Jacarei" ~ "Jacareí",
  municipio_circunscricao == "Jaguariuna" ~ "Jaguariúna",
  municipio_circunscricao == "Jardinopolis" ~ "Jardinópolis",
  municipio_circunscricao == "Jau" ~ "Jaú",
  municipio_circunscricao == "Jose Bonifacio" ~ "José Bonifácio",
  municipio_circunscricao == "Jundiai" ~ "Jundiaí",
  municipio_circunscricao == "Juquia" ~ "Juquiá",
  municipio_circunscricao == "Lavinia" ~ "Lavínia",
  municipio_circunscricao == "Lencois Paulista" ~ "Lençóis Paulista",
  municipio_circunscricao %in% c("Lourenço Da Serra", "São Lourenço Da Serra") ~ "São Lourenço da Serra",
  municipio_circunscricao == "Mairipora" ~ "Mairiporã",
  municipio_circunscricao == "Maracai" ~ "Maracaí",
  municipio_circunscricao == "Marilia" ~ "Marília",
  municipio_circunscricao == "Martinopolis" ~ "Martinópolis",
  municipio_circunscricao == "Matao" ~ "Matão",
  municipio_circunscricao == "Maua" ~ "Mauá",
  municipio_circunscricao %in% c("Mineiros Do Tiete", "Mineiros Do Tietê") ~ "Mineiros do Tietê",
  municipio_circunscricao == "Mogi Das Cruzes" ~ "Mogi das Cruzes",
  municipio_circunscricao == "Mogi-Guacu" ~ "Mogi Guaçu",
  municipio_circunscricao == "Mogi-Mirim" ~ "Mogi Mirim",
  municipio_circunscricao == "Mongagua" ~ "Mongaguá",
  municipio_circunscricao == "Monte Aprazivel" ~ "Monte Aprazível",
  municipio_circunscricao == "Nova Alianca" ~ "Nova Aliança",
  municipio_circunscricao == "Olimpia" ~ "Olímpia",
  municipio_circunscricao == "Orlandia" ~ "Orlândia",
  municipio_circunscricao == "Paraguacu Paulista" ~ "Paraguaçu Paulista",
  municipio_circunscricao == "Pariquera-Acu" ~ "Pariquera-Açu",
  municipio_circunscricao == "Pauliceia" ~ "Paulicéia",
  municipio_circunscricao == "Paulinia" ~ "Paulínia", 
  municipio_circunscricao == "Paulo De Faria" ~  "Paulo de Faria", 
  municipio_circunscricao == "Pedro De Toledo" ~ "Pedro de Toledo",
  municipio_circunscricao == "Peruibe" ~ "Peruíbe", 
  municipio_circunscricao == "Pilar Do Sul" ~ "Pilar do Sul", 
  municipio_circunscricao == "Pirapora Do Bom Jesus"  ~ "Pirapora do Bom Jesus",  
  municipio_circunscricao == "Poa" ~ "Poá",
  municipio_circunscricao == "Pongai" ~ "Pongaí",
  municipio_circunscricao == "Pradopolis" ~  "Pradópolis", 
  municipio_circunscricao == "Presidente Epitacio" ~ "Presidente Epitácio",
  municipio_circunscricao == "Quata" ~  "Quatá",
  municipio_circunscricao == "Ribeirao Branco" ~ "Ribeirão Branco",                       
  municipio_circunscricao == "Ribeirao Grande" ~ "Ribeirão Grande",
  municipio_circunscricao == "Ribeirao Pires" ~ "Ribeirão Pires",
  municipio_circunscricao == "Ribeirao Preto" ~ "Ribeirão Preto",
  municipio_circunscricao == "Rincao" ~ "Rincão",
  municipio_circunscricao == "Rinopolis" ~ "Rinópolis",
  municipio_circunscricao == "Rio Das Pedras" ~ "Rio das Pedras",
  municipio_circunscricao == "Rio Grande Da Serra" ~ "Rio Grande da Serra",
  municipio_circunscricao == "Rubiacea" ~ "Rubiácea", 
  municipio_circunscricao == "S.andre" ~ "Santo André",  
  municipio_circunscricao %in% c("S.barbara D Oeste", "Santa Bárbara D'oeste") ~ "Santa Bárbara d'Oeste",  
  municipio_circunscricao %in% c("S.bernardo Do Campo", "São Bernardo Do Campo") ~"São Bernado do Campo",
  municipio_circunscricao %in% c( "S.caetano Do Sul", "São Caetano Do Sul") ~ "São Caetano do Sul",
  municipio_circunscricao == "S.carlos" ~"São Carlos",
  municipio_circunscricao == "S.cruz Da Conceicao" ~ "Santa Cruz da Conceição",
  municipio_circunscricao %in% c("S.cruz Das Palmeiras", "Santa Cruz Das Palmeiras") ~ "Santa Cruz das Palmeiras", 
  municipio_circunscricao == "S.cruz Do Rio Pardo" ~ "Santa Cruz do Rio Pardo",
  municipio_circunscricao == "S.gertrudes" ~"Santa Gertrudes",
  municipio_circunscricao == "S.isabel" ~ "Santa Isabel",
  municipio_circunscricao == "S.joaquim Da Barra" ~ "São Joaquim da Barra",
  municipio_circunscricao %in% c("S.jose Do Rio Preto", "São José Do Rio Preto") ~ "São José do Rio Preto",
  municipio_circunscricao %in% c("S.jose Dos Campos", "São José Dos Campos") ~ "São José dos Campos",
  municipio_circunscricao == "S.luis Do Paraitinga" ~ "São Luiz do Paraitinga",
  municipio_circunscricao == "S.miguel Arcanjo" ~ "São Miguel Arcanjo",
  municipio_circunscricao == "S.paulo" ~ "São Paulo",
  municipio_circunscricao == "S.pedro" ~ "São Pedro",
  municipio_circunscricao == "S.roque" ~ "São Pedro",
  municipio_circunscricao == "S.rosa De Viterbo" ~ "Santa Rosa de Viterbo",
  municipio_circunscricao == "S.sebastiao" ~ "São Sebastião",
  municipio_circunscricao == "S.simao" ~ "São Simão",
  municipio_circunscricao == "S.vicente" ~ "São Vicente",
  municipio_circunscricao == "Salesopolis" ~ "Salesópolis",
  municipio_circunscricao == "Salto De Pirapora" ~ "Salto de Pirapora",
  municipio_circunscricao == "Santa Maria Da Serra" ~ "Santa Maria da Serra",
  municipio_circunscricao == "Santana De Parnaiba" ~ "Santana de Parnaíba",
  municipio_circunscricao == "Sao Joao Da Boa Vista" ~ "São João da Boa Vista",
  municipio_circunscricao == "Sertaozinho" ~ "Sertãozinho",
  municipio_circunscricao == "Sumare" ~ "Sumaré",
  municipio_circunscricao %in% c("Taboao Da Serra", "Taboão Da Serra") = "Taboão da Serra",
  municipio_circunscricao == "Tapirai" ~ "Tapiraí", 
  municipio_circunscricao == "Taubate" ~ "Taubaté",
  municipio_circunscricao == "Tatui" ~ "Tatuí",
  municipio_circunscricao == "Tiete" ~ "Tietê",
  municipio_circunscricao == "Tremembe" ~ "Tremembé",
  municipio_circunscricao == "Torre De Pedra" ~ "Torre de Pedra",
  municipio_circunscricao == "Tupa" ~ "Tupã",
  municipio_circunscricao == "Varzea Paulista" ~ "Várzea Paulista",
